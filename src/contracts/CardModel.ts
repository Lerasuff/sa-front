...
export class CardModel {
  ...
  constructor(id: number, attack: number, health: number, speed: number, distance: number, skin: string) {
    this.num = id;
...
export class CardModelDrag extends CardModel {
  ...
  constructor(card: CardModel, drag: boolean) {
    super(card.num, card.stats.atk, card.stats.hp, card.stats.spd, card.stats.dis, card.skin);
    this.draggable = drag;
  }
}
